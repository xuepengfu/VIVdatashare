function [outputArg1] = transferdis(inputArg1,runningstep,disdata,N_strip,rightnowtime,steptime)
%inputArg1 = 'fluids'
%disdata = [1000 1000 0];
...
parfor j = 1:length(filename)
    ...
    file_new = file_old;
    temp = ['        value           uniform (',num2str(disdata(j,1)),32, ...
        num2str(disdata(j,2)),32,'0);'];
